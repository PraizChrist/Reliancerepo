...
function Create-PowerBILinkedService {
    ...
    $itemTemplate = Get-Content -Path "$($TemplatesPath)/powerbi_linked_service.json"
    $item = $itemTemplate.Replace("#LINKED_SERVICE_NAME#", $Name)
                        .Replace("#WORKSPACE_ID#", $PowerBIworkspaceId)
                        # .Replace("#SUBSCRIPTION_ID#", $subscriptionId)
                        .Replace("#TENANT_ID#", $tenantID)
                        # .Replace("#RESOURCE_GROUP_NAME#", $resourceGroupName)
                        # .Replace("#AZUREML_WORKSPACE_NAME#", $amlWorkspaceName)
    $uri = "https://$($WorkspaceName).dev.azuresynapse.net/linkedservices/$($Name)?api-version=2019-06-01-preview"
...
# function Create-AzureMLLinkedService {
#     param(
#     [parameter(Mandatory=$true)]
#     [String]
#     $Name,
...
function Create-AzureMLLinkedService {
    ...
    $itemTemplate = Get-Content -Path "$($TemplatesPath)/AzureML_linked_service.json"
    $item = $itemTemplate.Replace("#LINKED_SERVICE_NAME#", $Name)
                        # .Replace("#WORKSPACE_ID#", $PowerBIworkspaceId)
                        .Replace("#SUBSCRIPTION_ID#", $subscriptionId)
                        # .Replace("#TENANT_ID#", $tenantID)
...
Export-ModuleMember -Function Create-AzureMLLinkedService